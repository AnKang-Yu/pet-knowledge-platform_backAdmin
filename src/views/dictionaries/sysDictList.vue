<template>
  <el-main>
    ...
    <!-- 搜索框elf
             ref 表单id
         -->
    <el-form ref="searchDict" :model="params" label-width="80px" :inline="true" size="small">
      ...
      <el-form-item>
        <el-button type="primary" icon="el-icon-circle-plus-outline" @click="addDict">新增</el-button>
      </el-form-item>
    </el-form>
    <!-- 操作弹框 -->
    <sys-dialog
    ...
    >
      <div slot="content">
        <!-- 新增字典弹窗 -->
        <el-form ref="addDictForm" :model="DictModel" :rules="rules" label-width="90px" :inline="true" size="normal">
          <el-form-item label="字典Id:" prop="dictId">
            <el-input v-model="DictModel.dictId" :disabled="true" />
          </el-form-item>
          <el-form-item label="字典Code:" prop="dictCode">
            <el-input v-model="DictModel.dictCode" />
          </el-form-item>
          <el-form-item label="字典名称:" prop="dictValue">
            <el-input v-model="DictModel.dictValue" />
          </el-form-item>
          <el-form-item label="字典备注:" prop="dictRemark">
            <el-input v-model="DictModel.dictRemark" />
          </el-form-item>
    ...
    <el-table :data="tableList" :height="tableHeight" empty-text="无数据" border stripe>
      ...
      <el-table-column prop="dictValue" label="字典名" align="center" />
      <el-table-column prop="dictRemark" label="字典备注" align="center" />
      <el-table-column prop="dictParentId" label="父字典ID" align="center" />
      <el-table-column prop="dictParentValue" label="父字典名" align="center" />
...
export default {
  ...
  methods: {
    ...
    async changeDictStatus(row) {
      ...
      const res = await editDictApi(param)
      if (res && res.code === 200) {
        // 更改成功,刷新列表
        this.findDictList()
