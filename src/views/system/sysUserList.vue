<template>
    <el-main>
        ...
        <!-- 搜索框elf
             ref 表单id
         -->
        <el-form :model="params" ref="searchUser"  label-width="80px" :inline="true" size="normal">
        ...
        >
            <div slot="content">
                <!-- 新增用户弹窗 -->
                    <el-form :model="UserModel" ref="addUserForm" :rules="rules" label-width="90px" :inline="true" size="normal">
                        <el-form-item label="用户名:" prop="userName">
                            <el-input v-model="UserModel.userName"></el-input>
                        </el-form-item>
                        <el-form-item label="用户账户:" prop="userAccount">
                            <el-input v-model="UserModel.userAccount"></el-input>
                        </el-form-item>
                        <el-form-item label="密码:" prop="userPassword">
                            <el-input  type="password" v-model="UserModel.userPassword"></el-input>
                        </el-form-item> 
                        <el-form-item label="电话:" prop="userPhone">
                            <el-input v-model="UserModel.userPhone"></el-input>
                        </el-form-item>
                        <el-form-item label="确认密码:" prop="checkPass">
                            <el-input  type="password" v-model="UserModel.checkPass"></el-input>
                        </el-form-item> 
                        <el-form-item label="邮箱:" prop="userEmail">
                            <el-input v-model="UserModel.userEmail"></el-input>
                        </el-form-item> 
