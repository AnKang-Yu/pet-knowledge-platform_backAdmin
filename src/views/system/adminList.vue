<template>
    <el-main>
        ...
        <!-- 搜索框elf
             ref 表单id
         -->
        <el-form :model="params" ref="searchAdmin"  label-width="80px" :inline="true" size="small">
            <el-form-item label="用户名">
                <el-input v-model="params.userName"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button @click="findUserList" icon="el-icon-search">查询</el-button>
                <el-button @click="addUser" type="primary" icon="el-icon-circle-plus-outline" >新增</el-button>
            </el-form-item>
        </el-form>
        <!-- 操作弹框 -->
        <sys-dialog 
        ...
        >
            <div slot="content">
                <!-- 新增员工弹窗 -->
                    <el-form :model="AdminModel" ref="addAdminForm" :rules="rules" label-width="90px" :inline="true" size="normal">
                        <el-form-item label="用户名:" prop="userName">
                            <el-input v-model="AdminModel.userName"></el-input>
                        </el-form-item>
                        <el-form-item label="用户账户:" prop="userAccount">
                            <el-input v-model="AdminModel.userAccount"></el-input>
                        </el-form-item>
                        <el-form-item label="密码:" prop="userPassword">
                            <el-input  type="password" v-model="AdminModel.userPassword"></el-input>
                        </el-form-item> 
                        <el-form-item label="电话:" prop="userPhone">
                            <el-input v-model="AdminModel.userPhone"></el-input>
                        </el-form-item>
                        <el-form-item label="确认密码:" prop="checkPass">
                            <el-input  type="password" v-model="AdminModel.checkPass"></el-input>
                        </el-form-item> 
                        <el-form-item label="邮箱:" prop="userEmail">
                            <el-input v-model="AdminModel.userEmail"></el-input>
                        </el-form-item> 
        ...
        <el-table :data="tableList" :height="tableHeight" empty-text="无数据" border stripe>
            ...
            <el-table-column prop="userAccount" label="账户名"></el-table-column>
            ...
            <el-table-column prop="userStatus" label="状态" align="center" width="140px">
                <template slot-scope="scope">
                    <el-switch v-model="scope.row.userStatus" :active-value="31" 
                    active-text="启用" :inactive-value="32" inactive-text="停用" 
...
export default {
  ...
  methods: {
      ...
      async changeUserStatus(row){
          ...
          let res = await editUserApi(param);
          if(res && res.code == 200){
                 //更改成功,刷新列表
                 this.findUserList();
      ...
      //获取管理员列表
      async findUserList(){
          let res = await findUserListApi(this.params);
          //返回成功
          if(res.code == 200){
            console.log(res);
